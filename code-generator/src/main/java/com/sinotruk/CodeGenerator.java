...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://10.100.113.6:3306/DataQuality");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("dataquality");
        dsc.setPassword("asdf1234!");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.sinotruk.server")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
